...
# with command line options: step2 --mc --eventcontent AODSIM,MINIAODSIM --runUnscheduled --datatier AODSIM,MINIAODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step RAW2DIGI,L1Reco,RECO,EI,PAT --era Run2_2016 --filein file:step_RAWSIM_bumpHunt.root --fileout file:step_MINIAODSIM_bumpHunt.root --python_filename step23_AOD_MINIAOD_v8020.py --no_exec
...
process.maxEvents = cms.untracked.PSet(
    ...
    #If you want to run a test job, can change this from -1 to number of events to run, and
    #change filename a few lines below to one of the output files from the previous step
...
process.source = cms.Source("PoolSource",
    fileNames =
    cms.untracked.vstring('file:{}'.format(fname)),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step_MINIAODSIM_aGun_a{}.root'.format(str(aMass).replace(".","_"))),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:{}'.format(outfname)),
